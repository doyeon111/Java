...
public class EmployeeTest {
	...
	public static void main(String[] args) {
		...
		Employee[] arr = new Employee[100]; //최대 여유있게 100개만큼 잡음
		//사용자한테 월급제 사원인지, 시간제 사원인지 물어보고 해당데이터를 입력받아 객체를 생성
		...
		// 급여를 계산하고 출력하기
		for (int i = 0; i < n; i++) { //입력한 수 만큼 반복실행하여 
			arr[i].computeSalary(); // 각 배열의 요소에 급여를 계산한다.
			System.out.println(arr[i]); //각 배열의 요소를 출력한다.
		}
	}
